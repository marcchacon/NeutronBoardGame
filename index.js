...
// setup pieces
var knight = jsboard.piece({text:"WK", textIndent:"-9999px", background:"red",   width:"50px", height:"50px", margin:"0 auto" });
var opp    = jsboard.piece({text:"BK", textIndent:"-9999px", background:"blue", width:"50px", height:"50px", margin:"0 auto" });
...
function showMoves(piece) {
    ...
    for (var i=0; i<newLocs.length; i++) {
        console.log(b.cell(newLocs[i]).DOM());
